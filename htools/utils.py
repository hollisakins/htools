...
#             if band=='f814w':
#                 return f'{simmons_prefix}/data/cosmos-web/mosaics/mosaic_cosmos_web_2024jan_30mas_tile_{tile}_hst_acs_wfc_f814w_{typ}.fits'
#             elif band=='f770w':
#                 return f'{simmons_prefix}/data/cosmos-web/mosaics/mosaic_miri_f770w_COSMOS-Web_30mas_{tile}_{typ}.fits'
#             else:
#                 return f'{simmons_prefix}/data/cosmos-web/mosaics/mosaic_nircam_{band}_COSMOS-Web_30mas_{tile}_{typ}.fits'
#         elif tile.startswith('A'):
#             if band=='f814w':
#                 return f'{simmons_prefix}/data/cosmos-web/mosaics/mosaic_cosmos_web_2023apr_30mas_tile_{tile}_hst_acs_wfc_f814w_{typ}.fits'
#             elif band=='f770w':
#                 return f'{simmons_prefix}/data/cosmos-web/mosaics/mosaic_miri_f770w_COSMOS-Web_30mas_{tile}_{typ}.fits'
#             else:
#                 return f'{simmons_prefix}/data/cosmos-web/mosaics/mosaic_nircam_{band}_COSMOS-Web_30mas_{tile}_{typ}.fits'
...
#             if typ.startswith('sci'): typ = typ.replace('sci','drz')
#             return f'{simmons_prefix}/data/primer/mosaics/mosaic_cosmos_primer_30mas_acs_wfc_{band}_{typ}.fits'
#         elif band in ['f125w','f160w']:
#             if typ.startswith('sci'): typ = typ.replace('sci','drz')
#             return f'{simmons_prefix}/data/primer/mosaics/mosaic_cosmos_primer_30mas_wfc3_ir_{band}_{typ}.fits'
#         elif band in ['f770w','f1800w']:
#             return f'{simmons_prefix}/data/primer/mosaics/mosaic_miri_{band}_PRIMER-COSMOS_60mas_{typ}.fits'
#         else:
#             return f'{simmons_prefix}/data/primer/mosaics/mosaic_nircam_{band}_PRIMER-COSMOS_30mas_{typ}.fits'

#     elif field=='ceers':
#         if band in ['f606w','f814w']:
#             return f'{simmons_prefix}/data/ceers/mosaics/{tile}/egs_all_acs_wfc_{band}_030mas_v1.9_{tile}_mbkgsub1.fits'
#         elif band in ['f105w','f125w','f140w','f160w']:
#             return f'{simmons_prefix}/data/ceers/mosaics/{tile}/egs_all_wfc3_ir_{band}_030mas_v1.9_{tile}_mbkgsub1.fits'
#         elif band in ['f115w','f150w','f200w','f277w','f356w','f410m','f444w']:
#             return f'{simmons_prefix}/data/ceers/mosaics/{tile}/ceers_{tile}_{band}_v1_mbkgsub1.fits'
